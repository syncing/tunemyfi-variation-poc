  ...
  return (
    <main className="min-h-screen bg-neutral-950 px-5 py-8 text-white">
      <section className="mx-auto max-w-6xl">
        ...
        {message && (
          <div className="mt-4 rounded-xl border border-neutral-800 bg-neutral-900 p-4 text-sm text-neutral-300 whitespace-pre-wrap">
            {message}
          </div>
        )}
        ...
        <div className="mt-6 grid gap-6">
              ...
              <label className="grid gap-2 text-sm">
                ...
                <input
                  ...
                  onChange={(e) => {
                      ...
                      updateField("productSlug", slugify(productName));
          ...
          <section className="rounded-2xl border border-neutral-800 bg-neutral-900 p-5">
            ...
            <button
              ...
              disabled={busy}
              className="mt-4 rounded-xl border border-neutral-700 px-5 py-3 text-sm text-neutral-300 disabled:opacity-50"
            >
              Check Assets
            </button>
            ...
            <div className="mt-4 grid gap-2 text-sm">
              {(state.assetResources ?? []).map((r: any) => (
                <div key={r.resourceId} className="rounded-xl border border-neutral-800 bg-neutral-950 p-3">
          ...
          <section className="rounded-2xl border border-neutral-800 bg-neutral-900 p-5">
            ...
            <button
              ...
              className="mt-4 rounded-xl bg-white px-5 py-3 text-sm font-bold text-black disabled:opacity-50"
            >
              {loadingAction === "generate-video" ? "Generating..." : "Generate Dubbed Review Video"}
            </button>
          </section>
